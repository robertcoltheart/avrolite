...
public ref struct AvroReader
{
    ...
    public AvroReaderState CurrentState => new(tokenType, elementIndices, readerOptions);
    ...
    private Schema? GetParentSchema()
    {
        var schema = currentSchema;

        while (schema is not RecordSchema or ArraySchema)
        {
